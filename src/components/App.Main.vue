            ...
            <div class="row">
                <div class="col-12">
                    <div class="content text-center">
                        <h3 class="violet-text">Our Love for animation</h3>
                        <h2 class="fs-50 purple-text">We're Storytelling <br> Experts With Creative <br> Smarts</h2>
                        <h5 class="mt-4 fw-100">our culture inspires the creative and innovative spirit found troughout <br> our Studio. We breath life into new ideas!</h5>
                    </div>    
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="content">
                        <div class="card yellow-gradient" style="width: 280px;">
                            ...
                            <div class="card-body text-center">
                                <h2 class="purple-text mb-3">3D modeling</h2>
            ...
            <div class="row">
                    ...
                    <div class="content mt-150">
                        <div class="card bg-yellow-card">
                            <div class="image-wrapper">
                                <img src="../imgs/team1.png" alt="team" class="team-img">
                            </div>
                            <div class="card-body pt-90 text-center">
                                <h3 class="purple-text mb-3 fw-bolder">Robert Coleman</h3>
                                <p class="card-text">Owner &amp; Creative Director</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-facebook social" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-twitter social" viewBox="0 0 16 16">
                                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334q.002-.211-.006-.422A6.7 6.7 0 0 0 16 3.542a6.7 6.7 0 0 1-1.889.518 3.3 3.3 0 0 0 1.447-1.817 6.5 6.5 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.32 9.32 0 0 1-6.767-3.429 3.29 3.29 0 0 0 1.018 4.382A3.3 3.3 0 0 1 .64 6.575v.045a3.29 3.29 0 0 0 2.632 3.218 3.2 3.2 0 0 1-.865.115 3 3 0 0 1-.614-.057 3.28 3.28 0 0 0 3.067 2.277A6.6 6.6 0 0 1 .78 13.58a6 6 0 0 1-.78-.045A9.34 9.34 0 0 0 5.026 15"/>
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-threads social" viewBox="0 0 16 16">
                ...
                <div class="col-4">
                    <div class="content mt-150">
                        <div class="card bg-yellow-card">
                            <div class="image-wrapper">
                                <img src="../imgs/team2.png" alt="team" class="team-img">
                            </div>
                            <div class="card-body pt-90 text-center">
                                <h3 class="purple-text mb-3 fw-bolder">Don Woods</h3>
                ...
                <div class="col-4">
                    <div class="content mt-150">
                        <div class="card bg-yellow-card">
                            ...
                            <div class="card-body pt-90 text-center">
                                <h3 class="purple-text mb-3 fw-bolder">Tomas Nash</h3>
                                <p class="card-text">2d animator&amp; Compositor</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-facebook social" viewBox="0 0 16 16">
                                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-twitter social" viewBox="0 0 16 16">
